...
\title{GPU Request:\\PikoGPT Pre-Training}
\author{FunkyAI}
\date{April 7, 2026}
...
\section*{GPU Request}
We are the Funky.ai team, and we request access to GPUs for Saturday, April 11, 2026.
Our repository is available at \href{https://github.com/chechmek/nlp-pikogpt-funkyai}{https://github.com/chechmek/nlp-pikogpt-funkyai}.
...
Plot and evaluation pipeline & \ok & Validation-loss evaluation exists during training; plotting is supported \\
Distributed training on 8 GPUs & \ok & DDP support is implemented and verified locally with 2 processes; 8-GPU execution is not directly testable on this machine. \\
Decisions and results outlined & \ok & Hyperparameter tuning results exist; architecture variants exist; \\
\bottomrule
\end{tabularx}
\end{table}
